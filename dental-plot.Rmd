---
title: "Plotting Dental Inventory"
author: Bjorn
output: 
  html_document: 
    theme: cosmo
...
This is a tutorial on an intuitive way to visualise a dental inventory in a 
sample. It requires only a basic knowledge of R, and, of course, that you have 
installed it along with RStudio.
...
```{r upload, eval=FALSE}
dental_inv <- readr::read_csv("https://github.com/bbartholdy/dental-inv-plot/data/dental-inv.csv")
```
